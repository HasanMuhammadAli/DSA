...
print("Pre-Order Iterative Traversal Result:")
...
print("Level-Order Traversal Result (BFS):")
...
print("BST:")
print(A2)
print("In_order of BST:")
in_order(A2)

print("Search in BST:")
#Search in BST Time: O(log n), Space: O(log n)
...
print(search_bst(A2, -1))#T
print(search_bst(A2, 10))#F
